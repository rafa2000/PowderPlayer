...
//		  console.log("file:///"+results[ij]+" ||| "+getName(results[ij]));
		    ...
		    powGlobals["videos"][newVideoId]["path"] = results[ij];
			powGlobals["videos"][newVideoId]["byteLength"] = fs.statSync(results[ij])["size"];
...
$(window).scroll(function() {
	...
	if ($(window).scrollTop() > $("#player_wrapper").height()) {
		$("#filesList").css("top","0");
		$("#header_container").css("position", "fixed");
	} else {
		$("#filesList").css("top","-79px");
