		...
		if (vlcPlayer.state == 2 || vlcPlayer.state == 3 || vlcPlayer.state == 4) {
			if (vlcPlayer.audio.count > 1) {
				...
				if (submenuHeight < mousesurface.height) {
					...
					submenuIt += ' Text { id: selectedIt; anchors.left: parent.left; anchors.leftMargin: 5; anchors.top: parent.top; anchors.topMargin: '+ selected +' +11; text: ui.icon.closePlaylist; font.family: fonts.icons.name; color: "#e5e5e5"; font.pointSize: 8 } ';
			...
			if (submenuHeight < mousesurface.height) {
				...
				for (plsi = 0; plsi < settings.aspectRatios.length; plsi++) {
					...
					submenuIt += ' Rectangle { id: sbmenu'+ plsi +'; height: 30; width: 100; anchors.left: parent.left; anchors.leftMargin: 1; anchors.top: parent.top; anchors.topMargin: ('+ plsi +' * 30) +1; color: "transparent"; Text { anchors.left: parent.left; anchors.leftMargin: 15; anchors.top: parent.top; anchors.topMargin: 7; text: "'+ settings.aspectRatios[plsi] +'"; color: "#e5e5e5"; font.pointSize: 11 } } ';
					preLogicIt += ' sbmenu'+ plsi +'.color = "transparent"; ';
				}
				for (plsi = 0; plsi < settings.aspectRatios.length; plsi++) {
					if (logicIt != "") logicIt += ' else';
			...
			if (submenuHeight < mousesurface.height) {
				...
				for (plsi = 0; plsi < settings.crops.length; plsi++) {
					...
					submenuIt += ' Rectangle { id: sbmenu'+ plsi +'; height: 30; width: 100; anchors.left: parent.left; anchors.leftMargin: 1; anchors.top: parent.top; anchors.topMargin: ('+ plsi +' * 30) +1; color: "transparent"; Text { anchors.left: parent.left; anchors.leftMargin: 15; anchors.top: parent.top; anchors.topMargin: 7; text: "'+ settings.crops[plsi] +'"; color: "#e5e5e5"; font.pointSize: 11 } } ';
					preLogicIt += ' sbmenu'+ plsi +'.color = "transparent"; ';
				}
				for (plsi = 0; plsi < settings.crops.length; plsi++) {
					if (logicIt != "") logicIt += ' else';
			...
			if (submenuHeight < mousesurface.height) {
				...
				for (plsi = 0; plsi < settings.zooms.length; plsi++) {
					...
					submenuIt += ' Rectangle { id: sbmenu'+ plsi +'; height: 30; width: 100; anchors.left: parent.left; anchors.leftMargin: 1; anchors.top: parent.top; anchors.topMargin: ('+ plsi +' * 30) +1; color: "transparent"; Text { anchors.left: parent.left; anchors.leftMargin: 15; anchors.top: parent.top; anchors.topMargin: 7; text: "'+ settings.zooms[plsi][1] +'"; color: "#e5e5e5"; font.pointSize: 11 } } ';
					preLogicIt += ' sbmenu'+ plsi +'.color = "transparent"; ';
				}
				for (plsi = 0; plsi < settings.zooms.length; plsi++) {
					if (logicIt != "") logicIt += ' else';
